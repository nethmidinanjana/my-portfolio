...
function HomePage() {
  return (
    <div className="text-black dark:text-white flex w-full h-auto justify-center items-center mt-20">
      ...
      <div className="w-full lg:w-1/2 md:w-1/2 xl:w-1/2 2xl:w-1/2 bg-red-200">2</div>
    </div>
  );
}
